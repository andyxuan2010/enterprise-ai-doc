...
variable "create_sql_database" {
  description = "Whether to create the Azure SQL logical server and database. When false, the existing sql_server_name and sql_database_name are read with data sources."
  type        = bool
  default     = false
}

variable "sql_server_name" {
  description = "Azure SQL logical server name. When create_sql_database is false, this must identify an existing server to look up."
  type        = string
  default     = ""
}

variable "sql_database_name" {
  description = "Azure SQL database name. When create_sql_database is false, this must identify an existing database to look up."
  type        = string
  default     = ""
}
...
variable "sql_use_free_limit" {
  description = "Whether to enable Azure SQL free monthly limits for eligible serverless databases."
  type        = bool
  default     = false
}

variable "sql_free_limit_exhaustion_behavior" {
  description = "Behavior when Azure SQL free monthly limits are exhausted. AutoPause pauses the database for the rest of the month; BillOverUsage allows billable overage."
  type        = string
  default     = "AutoPause"
...
variable "sql_geo_backup_enabled" {
  description = "Whether geo backups are enabled for the Azure SQL database."
  type        = bool
  default     = true
}
