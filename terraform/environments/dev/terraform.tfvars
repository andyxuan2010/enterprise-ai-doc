...
landingzone_storage_account_name  = "stplatformccdev"
iac_storage_account_name          = "stccoeiacccdev"
landingzone_key_vault_name        = "kvplatformccdev"
iac_key_vault_name                = "kv-ccoe-cc-dev"
landingzone_log_analytics_name    = "law-platform-cc-dev"
landingzone_openai_name           = "oai-platform-cc-dev"
landingzone_azure_ai_service_name = "ai-platform-cc-dev"

function_app_name = "func-aidoc-dev"
logic_app_name    = "logic-aidoc-dev"
// create_sql_database = false reuses the existing SQL DB named below via data source.
// Set create_sql_database = true to create SQL here; then the SQL settings below become effective.
create_sql_database = false
sql_server_name     = "sql-platform-cc-dev"
sql_database_name   = "sqldb-platform-dev"
...
sql_admin_credentials_key_vault_id = "/subscriptions/1ec5edd4-5654-4246-8027-b29ef63b3393/resourceGroups/rg-ccoe-iac-cc-dev/providers/Microsoft.KeyVault/vaults/kv-ccoe-cc-dev"
